...
<<<<<<< HEAD:tests/e2e/tests/web/regression/insights/feature-flag.e2e.ts
...
>>>>>>> feature/RI-4943_rework-tutorials:tests/e2e/tests/regression/insights/feature-flag.e2e.ts
});
